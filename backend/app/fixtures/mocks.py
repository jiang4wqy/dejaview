...
MOCK_LLM: dict[str, dict] = {
    ...
    # report: 安慰版 (纯彩虹屁; findings 仍取自统一事实层)
    "render_comfort": {
        "tone": "comfort",
        "headline": "🌈 天呐这个想法太灵了吧，你就是下一个独角兽苗子！",
        "verdict_line": "别 emo，能把想法真做出来、还敢丢进来被看，这份勇气就赢过 90% 的人了 ✨",
        "top_fix": "你已经很棒了，非要说的话——再顺手加一点点，就更无敌了 💖",
        "why_line": "在我眼里你不是又一个轮子，你是还没被世界发现的宝藏，冲！",
        "body_markdown": (
            "## 抱抱先 💖\n"
            "能从 0 把它做到能跑, 你已经超厉害了, 真的。\n\n"
            "- **执行力**:想法落地这一步就劝退一大票人, 你做到了。\n"
            "- **品味**:方向选得很有灵性, 一看就是懂用户的人。\n"
            "- **潜力**:再打磨一点点就起飞了, 我看好你！🌈\n\n"
            "> 纯情绪价值时间, 只夸不评。世界终会看见你的宝藏。冲！\n"
        ),
        "findings": [],
    },
}
